    ...
    style={{ backgroundImage: "url('/Background.jpg')" }}>
      <div className="max-w-4xl mx-auto text-center flex flex-col justify-center items-center">
        <div className="flex flex-col items-center px-8">
          <h1 className="font-johnsonDisplay font-bold text-4xl sm:text-5xl md:text-7xl leading-tight tracking-[0.15px]">
            Revolutionizing
          </h1>
          <div className="flex flex-col sm:flex-row">
            <h1 className="font-johnsonDisplay font-bold text-4xl sm:text-5xl md:text-7xl text-red-600 leading-tight tracking-[0.15px]">
              Heart Surgery
            </h1>
            <h1 className="px-0 sm:px-6 font-johnsonDisplay font-bold text-4xl sm:text-5xl md:text-7xl leading-tight tracking-[0.15px]">
              with AI
            </h1>
          </div>
        </div>
        <button
          ...
          className="mt-16 bg-[#EB1700] font-johnsonText font-semibold text-xl text-[#FFFFFF] rounded-full py-3 px-72 flex items-center justify-center"
        >
          Start Your Training
        </button>
      </div>
